...
* *Remaining:* P5 and P6, handed off in `docs/p5-p6-handoff.adoc`. Decision
  recorded there: the `refs/meta/auth` → `refs/meta/members` rename is a *hard
  break with no fallback* — the live trust list is discarded and re-pushed after
  a redeploy.
